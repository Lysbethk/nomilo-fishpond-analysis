...
ksf_weather_water_quality_interactive_plot <- function(df, var_name, y_var_title_label, names_units) {
  ...
  plot <- plot_ly(df, x = ~date, y = as.formula(paste0("~", var_name)), type = 'scatter', mode = 'lines+markers',
    ...
    layout(
      ...
      updatemenus = list(
        list(
          ...
          y = 1.28,  # Place the dropdown menu above the plot
...
color_scale <- c("-1" = "#E54E21", "0" = "grey", "1" = "#6C8645")
...
oyster_growth_plot <- plot_ly(
  ...
  text = ~hover_text,
  hoverinfo = 'text',
  line = list(color = "#6C8645"),  # Set line color to green
  marker = list(color = "#6C8645", size = 5)  # Set marker color to green
) %>%
  layout(
  ...
  layout(
    annotations = list(
      ...
      list(
        ...
        xref = 'paper',
        yref = 'paper',
        text = '<span style="color:#E54E21">Decrease</span>',
        showarrow = FALSE,
        font = list(size = 13.5)
      ),
      list(
        ...
        xref = 'paper',
        yref = 'paper',
        text = '<span style="color:grey">Constant</span>',
        showarrow = FALSE,
        font = list(size = 13.5)
      ),
      list(
        ...
        xref = 'paper',
        yref = 'paper',
        text = '<span style="color:#6C8645">Increase</span>',
        showarrow = FALSE,
        font = list(size = 13.5)
      )
    ),
