...
profiles_data_tidied <- profiles_data %>% #<2>
  ...
  mutate(location = str_to_title(location)) # <14>
...
#| fig-height: 10
#| echo: false
ggplot(profiles_data_tidied, aes(x = date, y = conductivity, color = as.factor(depth))) +
  geom_point(size = 1.5, alpha = 0.8) +
  geom_line(size = 1, alpha = 0.6) + 
  facet_wrap(~ location, scales = "free_y") +
  theme_minimal() +
  labs(color = "Depth", x = "Month", y = "Conductivity", title = "Conductivity Over Time by Location and Depth") +
