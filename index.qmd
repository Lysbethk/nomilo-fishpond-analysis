...
```{r}
# export_to_csv(profiles_data_tidied, "profiles_data_tidied", "data/output")
```
...
```{r}
paired_plot <- ggplot(ksf_clams_growth_data_tidied, aes(x = date, y = weight, group = date, color = clams_stage)) +
