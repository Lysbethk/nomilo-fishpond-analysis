...
#| eval: false
#| code-fold: true
#| code-summary: "Step 3: Use the `purrr::map()` function to iteratively import files in the `files_to_import` vector except for the profiles data and .RData files"
dfs_no_profiles <- map(files_to_import[c(2:7)], import_list) # <1>
...
#| code-fold: true
#| code-summary: "Step 4: Efficiently import up-to-date raw data"
